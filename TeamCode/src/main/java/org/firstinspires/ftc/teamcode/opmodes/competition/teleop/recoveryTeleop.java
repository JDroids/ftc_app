...
@TeleOp(name = "RecoveryTeleop")

public class recoveryTeleop extends LinearOpMode {
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            moveArcadeFOD(gamepad1, constants.FIELD_SIDE.RECOVERY_SIDE, constants.JDColor.RED, this); //The color is irrelevant for Recovery side
